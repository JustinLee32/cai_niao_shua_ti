...
#在 "100 game" 这个游戏中，两名玩家轮流选择从 1 到 10_7 周赛.5 双周赛 的任意整数，累计整数和，先使得累计整数和达到 100 的玩家，即为胜者。
#
...
#
#输入：
#maxChoosableInteger = 10_7 周赛.5 双周赛
#desiredTotal = 11
#
#输出：
#false
...
#解释：
#无论第一个玩家选择哪个整数，他都会失败。
#第一个玩家可以选择从 1 到 10_7 周赛.5 双周赛 的整数。
#如果第一个玩家选择 1，那么第二个玩家只能选择从 2 到 10_7 周赛.5 双周赛 的整数。
#第二个玩家可以通过选择整数 10_7 周赛.5 双周赛（那么累积和为 11 >= desiredTotal），从而取得胜利.
...
# m,n
# 9/40: 30,20,10_7 周赛.5 双周赛 False
# 9/39: 29,19,9 False -> m-1,n-m  # 8/30 21,12,3
# 9/38: 28,18,8 True
# 9/37: 27,17,7 True

# 10_7 周赛.5 双周赛/40: 7,18,29,40	   6, 13,29
#					   11,22,33
# 7,8
# 4,3
# 9/39: 9,19,29,39,49
